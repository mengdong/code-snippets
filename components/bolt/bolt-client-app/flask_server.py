...
from bolt_client import get_prediction, random_bolt

app = Flask(__name__)

name_arg = os.getenv('MODEL_SERVE_NAME', 'bolt')
...
def main():
  ...
  try:
    ...
    file_name, truth, serving_path = random_bolt('/workspace/web_server/static/small_bolt')
