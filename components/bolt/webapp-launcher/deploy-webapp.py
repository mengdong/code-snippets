...
def main():
  ...
  parser.add_argument(
      '--trtserver_name', default='trtserver', type=str,
      help='...',
      required=True)
  parser.add_argument(
      '--workflow_name', default='testworkflow', type=str,
      help='...',
      required=True)
  parser.add_argument(
      '--model_name', default='bolt', type=str,
      help='...',
      required=True)
  parser.add_argument(
      '--model_version', default='1', type=str,
      help='...',
      required=True)
  parser.add_argument(
      '--webapp_prefix', default='webapp', type=str,
      help='...',
      required=True)
  parser.add_argument(
      '--webapp_port', default='80', type=str,
      help='...',
      required=True)
  ...
  template_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'boltapp-template.yaml')
  target_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'boltapp.yaml')
  ...
  subprocess.call(['kubectl', 'create', '-f', '/ml/boltapp.yaml'])
